/**
 * 
 *  * Card and Feature je child components ahet te HTML cha jo class ahe tyachya current value nusar theme 
 * update karnar 
 * 
 */
...
export default function Feature() {
  return (
    <>
      <div className="bg-white py-24 sm:py-32 dark:bg-gradient-to-r from-blue-950 to-blue-500 dark:text-white dark:font-mono">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-indigo-600 dark:text-white">
              Deploy faster
            </h2>
          ...
          <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl dark:text-white">
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
              <div className="relative pl-16">
                <dt className="text-base font-semibold leading-7 text-gray-900">
                  ...
                  <label htmlFor="" className="dark:text-white">Push to deploy</label> 
                </dt>
              ...
              <div className="relative pl-16">
                <dt className="text-base font-semibold leading-7 text-gray-900">
                  ...
                  <label htmlFor="" className="dark:text-white">SSL Certificates</label> 
                </dt>
                <dd className="mt-2 text-base leading-7 text-gray-600 dark:text-white">
              ...
              <div className="relative pl-16">
                <dt className="text-base font-semibold leading-7 text-gray-900">
                  ...
                  <label htmlFor="" className="dark:text-white">Simple Queues</label> 
                </dt>
                <dd className="mt-2 text-base leading-7 text-gray-600 dark:text-white">
              ...
              <div className="relative pl-16">
                <dt className="text-base font-semibold leading-7 text-gray-900">
                  ...
                  <label htmlFor="" className="dark:text-white">Advanced security</label> 
                </dt>
                <dd className="mt-2 text-base leading-7 text-gray-600 dark:text-white">
